    ...
    func atRuleMediaSnapshotMobile() {
        assertInlineSnapshot(
            of: HTMLDocument {
                ...
                .inlineStyle("font-size", "14px", atRule: AtRule(rawValue: "@media (max-width: 768px)"))
            },
            as: .html
        ) {
            """
            ...
            of: HTMLDocument {
                tag("div") {
                    tag("h1") { "Responsive Title" }
                        .inlineStyle("font-size", "24px", atRule: AtRule(rawValue: "@media (min-width: 768px)"))
                        .inlineStyle("font-size", "18px", atRule: AtRule(rawValue: "@media (max-width: 767px)"))
                    
                    tag("p") { "This paragraph adapts to different screen sizes" }
                        .inlineStyle("margin", "1rem", atRule: AtRule(rawValue: "@media (min-width: 768px)"))
                        .inlineStyle("margin", "0.5rem", atRule: AtRule(rawValue: "@media (max-width: 767px)"))
                        .inlineStyle("display", "none", atRule: AtRule(rawValue: "@media print"))
                }
            },
            as: .html
