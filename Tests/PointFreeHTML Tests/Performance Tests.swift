...
struct PerformanceTests {
  ...
  private func getMemoryUsage() -> Int64 {
      ...
      // Swift 6: mach_task_self_ is a Darwin system global that's not marked as Sendable.
      // It's safe to access here as it's a read-only global provided by the system.
