...
struct PerformanceTests {
    ...
    func largeDocumentRendering() throws {
        ...
        print("   Time: \(result)")
        print("   Time (seconds): \(Double(result.components.seconds) + Double(result.components.attoseconds) / 1e18)")
        print("   Items per second: \(Double(itemCount) / (Double(result.components.seconds) + Double(result.components.attoseconds) / 1e18))")
    ...
    func styleDeduplicationPerformance() throws {
        ...
        print("   Time (seconds): \(Double(result.components.seconds) + Double(result.components.attoseconds) / 1e18)")
        print("   Elements per second: \(Double(itemCount) / (Double(result.components.seconds) + Double(result.components.attoseconds) / 1e18))")
        print("   Time: \(result)")
    ...
    func configurationPerformanceComparison() throws {
        ...
        let compactTimeInSeconds = Double(compactResult.components.seconds) + Double(compactResult.components.attoseconds) / 1e18
        let prettyTimeInSeconds = Double(prettyResult.components.seconds) + Double(prettyResult.components.attoseconds) / 1e18
        ...
        print("   Compact performance: \(String(format: "%.2f", Double(itemCount * 3) / compactTimeInSeconds)) elements/sec")
        print("   Pretty performance: \(String(format: "%.2f", Double(itemCount * 3) / prettyTimeInSeconds)) elements/sec")
