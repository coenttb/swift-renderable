...
extension _Conditional: Renderable
where
    First: Renderable, Second: Renderable, First.Context == Second.Context,
...
extension _Conditional: AsyncRenderable
where First: AsyncRenderable, Second: AsyncRenderable, First.Context == Second.Context {
