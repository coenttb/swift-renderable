...
extension Rendering {
    ...
    ///
    /// `Rendering.Builder` provides a DSL for constructing content in Swift code.
    ...
    /// (like HTML Rendering, PDF Rendering) constrain the types appropriately
    ...
    public enum Builder {
        ...
        ) -> Rendering._Conditional<First, Second> {
            .first(component)
        }
